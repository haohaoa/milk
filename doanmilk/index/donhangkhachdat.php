...
<head>
    ...
    <title>Đơn hàng khách đặt</title>
    <style>
        /* CSS for the table */
        body {
...
<body>
    ...
    <div class="container">
    <h2>Đơn Hàng Khách Đã Đặt</h2>
    <!-- lấy tất cả dử liệu từ giỏ hàng  -->
    <?php include_once __DIR__.'/../backend/allspThanhToan.php';?>
    ...
    <table class="giohang" id="giohang">
        ...
        ?>
            <tr>
                ...
                <td> 
                    <a style="text-decoration: none;" href="/index/chitietdonhang.php?id=<?php echo $gh['MaThanhToan']; ?>" class="delete-btn"><?php echo $gh['TrangThai'];?></a>
                </td>
            </tr>
